...
#os.chdir(r"C:\Users\Zati Hakim\Desktop\FYP\Trash-Detection-master\Trash-Detection-master\trash_rtx")
...
class darknet_main():
    def __init__(self):
        ...
        self.configPath = './model/yolov4-obj.cfg'
        self.weightPath = './model/yolov4-obj_last.weights'
        self.metaPath = "./model/obj.data"
        self.frame = None
